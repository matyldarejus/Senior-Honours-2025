...
if __name__ == '__main__':
    ...
    sample_file = f'{sample_dir}{model}_{wind}_{snap}_galaxy_sample.h5' # Use the galaxy samples generated and append
    ...
    print(f'Update the attributes to include the temperature')
