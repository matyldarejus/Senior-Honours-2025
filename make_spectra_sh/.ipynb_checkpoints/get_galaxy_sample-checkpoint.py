...
sample_dir = f'/disk04/mrejus/sh/samples/' # save the samples to my disk04 directory
data_dir = f'/disk04/rad/sim/{model}/{wind}/' # access the simulation data necessary
